...
//  @Before
//  public void setUp() {
//    this.trier = new Trier(TryCountAndInterval.of(count, Time.of(1000L)));
...
//        }
//        latch.countDown();
//        final CommitException rpcCommitException =
//            new CommitException(types.Rpc.CommitStatus.TX_NONCE_TOO_LOW, "Nonce is too low");
