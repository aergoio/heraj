...
public class UnlockAccountTest extends AbstractTestCase {
  ...
  public void testExecute() throws Exception {
    ...
    // When
    final UnlockAccount command = new UnlockAccount(accountRepository);
    ...
    verify(accountRepository).unlock(eq(address), eq(password));
  }
