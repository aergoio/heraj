...
public class TransactionAsyncTemplate implements TransactionAsyncOperation, ChannelInjectable {
  ...
  private final Supplier<
      Function1<TxHash, ResultOrErrorFuture<Transaction>>> transactionFunctionSupplier =
          memoize(() -> StrategyChain.of(context).apply((txHash) -> {
  ...
  private final Supplier<
      Function1<Transaction, ResultOrErrorFuture<TxHash>>> commitFunctionSupplier =
          memoize(() -> StrategyChain.of(context).apply((transaction) -> {
  ...
  private final Supplier<Function3<AccountAddress, AccountAddress, Long,
      ResultOrErrorFuture<TxHash>>> sendFunctionSupplier =
          memoize(() -> StrategyChain.of(context).apply((sender,
              recipient, amount) -> {
            final Tracer tracer = GlobalTracer.get();
